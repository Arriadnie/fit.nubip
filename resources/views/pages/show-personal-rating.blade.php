...
@section('content')
    ...
    <div class="container-table personal-room">
        ...
        <div class="filter-wrap">
            ...
            <label class="select">
                <select class="default-select" name="period1">
            ...
            <label class="select">
                <select class="default-select" name="period2">
                ...
                <div class="rating-grade">
                    ...
                    <label class="select">
                        ...
                        <select class="default-select" name="block">
                            ...
                            {{--                            <optgroup label="2. Навчально-наукова робота">--}}
                            {{--                                <option value="2.1">2.1 Особисті досягнення</option>--}}
                            {{--                                <option value="2.2">2.2 Конференції</option>--}}
                            {{--                                <option value="2.3">2.3 Інтелектуальні конкурси</option>--}}
                            {{--                            </optgroup>--}}
                    ...
                    <label class="select">
                        ...
                        <select class="default-select" name="punkt">
                            ...
                            <option value="3">Секретар СО Університету, керівники відділів СО Університету, керівники
                                клубів за інтересами (на рівні університету) **
                            </option>
                        </select>
                    </label>
                    <label class="total">
